...
const AboutSection = () => {
  ...
  return (
    <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-white via-blue-50 to-indigo-100 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-6">
              ...
              <div className="w-24 h-2 bg-gradient-to-r from-primary-color via-secondary-color to-accent-color rounded-full mx-auto lg:mx-0 animate-pulse"></div>
            </div>
          ...
          {/* Right Content - Achievements Card */}
          <div className="relative order-first lg:order-last">
            <div className="relative bg-white/30 backdrop-blur-xl rounded-2xl p-8 md:p-10 border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-2 gap-6 md:gap-8">
                  {achievements.map((achievement, index) => (
                    <div 
                      key={index} 
                      className="group text-center p-6 bg-white/40 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/60 transition-all duration-300 hover:scale-105"
                    >
                      {/* Icon */}
                      ...
                      {/* Number */}
                      <div className="text-2xl md:text-3xl font-black mb-2 bg-gradient-to-r from-primary-color to-secondary-color bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">
                        {achievement.number}
                      </div>
