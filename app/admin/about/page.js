        ...
        <div className="p-6">
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 text-center">
            <div className="text-gray-500">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">About Us Management</h3>
              <p className="text-gray-500">About us content management features will be available soon.</p>
            </div>
          </div>
        </div>
      </div>
